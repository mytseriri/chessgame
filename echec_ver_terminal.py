    ...
    while en_cours:
        ...
        if rép == "0":
            ...
            try:
                ...
                rép=input("Erreur ! Veuillez entrer uniquement des entiers ! Quel es ton coup ?")
            ...
            if vérif(réponse[0],réponse[1],plateau,rock_gauche_blanc,rock_droit_blanc,rock_gauche_noir,rock_droit_noir)\
                ...
                if piece[0]=="Tour":
                    ...
                    is_prom=False
                    while is_prom==False:
                        prom=input("Quelle est la promotion que tu souhaites ?")
...
Plat = fen_plateau("8/8/8/8/8/4r3/8/K6r")
partie(Plat)
